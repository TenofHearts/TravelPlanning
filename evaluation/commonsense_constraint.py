        ...
        for activity_i in day_plan_i["activities"]:
            ...
            if activity_i["type"] == "breakfast" and select_restaurant.empty:
                ...
                if time_compare_if_earlier_equal(
                    "09:00", activity_i["start_time"]
                ) or time_compare_if_earlier_equal(activity_i["end_time"], "06:00"):
            ...
            if activity_i["type"] == "lunch" and (
                time_compare_if_earlier_equal("13:00", activity_i["start_time"])
                or time_compare_if_earlier_equal(activity_i["end_time"], "11:00")
            ):
            ...
            if activity_i["type"] == "dinner" and (
                time_compare_if_earlier_equal("20:00", activity_i["start_time"])
                or time_compare_if_earlier_equal(activity_i["end_time"], "17:00")
            ):
            ...
            if time_compare_if_earlier_equal(
                endtime, activity_i["start_time"]
            ) or time_compare_if_earlier_equal(activity_i["end_time"], opentime):
                return return_info(
                    False,
